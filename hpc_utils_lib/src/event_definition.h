...
DECLARE_CLASS_EVENTS(INSTRUCTION_COMMIT_EVENT_CLASS,
                     EXCEPTION_TAKEN,
                     INTEGER_LOAD_INSTRUCTION_RETIRED,
                     INTEGER_STORE_INSTRUCTION_RETIRED,
                     ATOMIC_MEMORY_OPERATION_RETIRED,
                     SYSTEM_INSTRUCTION_RETIRED,
                     INTEGER_ARITHMETIC_INSTRUCTION_RETIRED,
                     CONDITIONAL_BRANCH_RETIRED,
                     JAL_INSTRUCTION_RETIRED,
                     JALR_INSTRUCTION_RETIRED,
                     INTEGER_MULTIPLICATION_INSTRUCTION_RETIRED,
                     INTEGER_DIVISION_INSTRUCTION_RETIRED,
