...
//
//    hpc_event_selector_t hpcEventMask;
//    hpcEventMask.selector_id = EVENT_SELECTOR_10;
//    hpcEventMask.events.instruction_commit_events.floating_point_load_instruction_retired
//
//    if (argc != 4){
